---
title: "Assignment R course June 2024"
author: "Renee Menezes and Renaud Tissier"
date: "`r Sys.Date()`"
...
```{r}
boxplot(warpbreaks$breaks~warpbreaks$wool, data=warpbreaks)
boxplot(warpbreaks$breaks~warpbreaks$tension, data=warpbreaks)
...
boxplot(warpbreaks$breaks~warpbreaks$wool+warpbreaks$tension)
```
